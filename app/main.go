...
var (
	inputFile  = flag.String("source", "/Users/zabon/Desktop/crm-yang.postman_collection.json", "Postman 导出的json文件")
	//inputFile  = flag.String("source", "/Users/zabon/Desktop/code/元典接口/yang/crm-yang.20191231.json", "Postman 导出的json文件")
	outputFile = flag.String("output", "/Users/zabon/code/swagger-php/ydt.php", "产生的注释文件")

	host        = flag.String("host", "tpa.test", "项目地址,例如：api.xx.com")
	basePath    = flag.String("base_path", "/", "项目地址,例如 /")
	title       = flag.String("title", "易点通API", "项目名称")
